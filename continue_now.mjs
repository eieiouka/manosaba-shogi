...
continueCheckpointGraph(g,{maxExpanded:g.head+100000,maxMillis:100000,onProgress:x=>{if(x.expanded%50000===0)console.log(x,'rssMB',process.memoryUsage().rss/1e6)}});
